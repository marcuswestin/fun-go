...
type Tx interface {
	...
	SelectInt(query string, args ...interface{}) (num int64, err error)
	SelectString(query string, args ...interface{}) (str string, err error)
	SelectUint(query string, args ...interface{}) (num uint, err error)

	SelectIntMaybe(query string, args ...interface{}) (num int64, found bool, err error)
	...
	SelectIntForce(query string, args ...interface{}) (num int64, err error)
